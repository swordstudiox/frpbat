...
ECHO.::     ±¾½Å±¾ÓÉ ¡î‰ô»ÃŸ“›ï¡î ±àĞ´£¬ÈçÓĞÒÉÎÊÇëÁªÏµ±¾ÈË£¡ http://www.lu8.win  ::
ECHO.::     ±¾½Å±¾ÓÉswordĞŞ¸ÄÓÅ»¯£¬²©¿ÍµØÖ·£º https://agint.me                   :: 
ECHO.::     Ãâ·ÑfrpÄÚÍø´©Í¸·şÎñÆ÷µØÖ·£º https://freenat.win                      ::
ECHO.::     ÏîÄ¿µØÖ·£º https://github.com/swordstudiox/frp_bat                   ::
ECHO.::     ×ªÔØÇë²»ÒªÉ¾³ı±¾ĞÅÏ¢£¡                                               ::
ECHO.::                                                                          ::
ECHO.::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
ECHO.
ECHO.
