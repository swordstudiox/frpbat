...
linux(){
notice=`curl -s https://github.com/swordstudiox/frpbat/raw/master/tips | sed -n 's/tips\=//p'`
versiontime=`curl -s https://github.com/swordstudiox/frpbat/raw/master/tips | sed -n 's/versiontime\=//p'`
banquan(){
echo "::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::"
echo "::                                                                          ::"
...
download(){
			...
			echo ""
			curl -# -o frps https://github.com/swordstudiox/frpbat/raw/master/frp/linux/$os/$version/frps
			if [ $? == 0 ];then				
				run
				else				
				echo "下载失败,请到https://github.com/swordstudiox/frpbat/raw/master/frp/linux手动下载程序。"
				echo ""
				echo "请按回车键返回配置"
				read
				config
...
os_select(){
	...
	echo ${ECHOcolor2} "${ECHOstart2}2、linux_arm${ECHOend2}"
	echo ${ECHOcolor3} "${ECHOstart3}3、linux-mips${ECHOend3}"
	echo ${ECHOcolor4} "${ECHOstart4}4、linux-mipsle${ECHOend4}"
	echo ${ECHOcolor5} "${ECHOstart5}5、linux_mips32le${ECHOend5}"
