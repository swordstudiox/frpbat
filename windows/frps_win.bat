...
echo oShellLink.Description = "由 ☆夢幻煋涳☆ & sword 制作"  '备注 >>frps.vbs
...
ECHO. 下载失败！
ECHO. 
ECHO. 请到https://github.com/swordstudiox/frpbat/raw/master/frp/windows手动下载,
ECHO. 并将frps.exe程序放在与该脚本同目录下即可。
del frps.exe
ECHO. 
