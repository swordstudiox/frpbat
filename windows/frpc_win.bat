...
goto windows
:windows
set date1=V1.0-20190302

@echo off
title frpc配置脚本  %date1%  
COLOR 02
cls
cd %~dp0
...
ECHO.
set server_addr=freenat.win
set server_port=7000
set privilege_token=frp888
set token=frp888
set login_fail_exit=false
set protocol=tcp
...
call :download "https://github.com/swordstudiox/frpbat/raw/master/frp/windows/%version%/frpc.exe" frpc.exe
goto start
...
echo oShellLink.Description = "由 ☆夢幻煋涳☆ &sword 制作"  '备注 >>frpc.vbs
